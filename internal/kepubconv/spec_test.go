...
// squash drops every space. Two blocks that touch in the source ("</p><p>") are
// separated in the output, and a converter is entitled to do that — what it is
// not entitled to do is change a single character a reader sees.
