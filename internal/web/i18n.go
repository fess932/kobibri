...
var catalog = map[string]map[Lang]string{
	...
	// Reading statistics
	"nav.stats":   {LangEN: "Reading", LangRU: "Чтение"},
	"stats.title": {LangEN: "Reading", LangRU: "Чтение"},
	"stats.lede": {
		LangEN: "Built from what your reader reports as you go: how long you actually read, how fast, and how much of a book is left at that pace.",
		LangRU: "Собрано из того, что читалка сообщает по ходу дела: сколько вы на самом деле читали, с какой скоростью и сколько книги осталось при таком темпе.",
	},
	"stats.none": {
		LangEN: "Nothing yet. Read a few pages on a reader and sync — progress reports are what this is made of.",
		LangRU: "Пока пусто. Почитайте на читалке и синхронизируйтесь — статистика собирается из отчётов о прогрессе.",
	},
	"stats.timeRead":      {LangEN: "Time read", LangRU: "Время чтения"},
	"stats.speed":         {LangEN: "Speed", LangRU: "Скорость"},
	"stats.wpm":           {LangEN: "words a minute", LangRU: "слов в минуту"},
	"stats.words":         {LangEN: "Words", LangRU: "Слова"},
	"stats.read":          {LangEN: "Read", LangRU: "Прочитано"},
	"stats.left":          {LangEN: "Left in this book", LangRU: "Осталось в книге"},
	"stats.ofWords":       {LangEN: "of", LangRU: "из"},
	"stats.books":         {LangEN: "books", LangRU: "книг"},
	"stats.finished":      {LangEN: "finished", LangRU: "дочитано"},
	"stats.streak":        {LangEN: "Streak, days", LangRU: "Серия, дней"},
	"stats.longest":       {LangEN: "longest", LangRU: "рекорд"},
	"stats.perDay":        {LangEN: "On a reading day", LangRU: "В день чтения"},
	"stats.activeDays":    {LangEN: "days with reading", LangRU: "дней с чтением"},
	"stats.lastWeek":      {LangEN: "Last seven days", LangRU: "За неделю"},
	"stats.since":         {LangEN: "since", LangRU: "с"},
	"stats.sittings":      {LangEN: "sittings", LangRU: "подходов"},
	"stats.sittingsTitle": {LangEN: "Recent sittings", LangRU: "Последние подходы"},
	"stats.calendar":      {LangEN: "The year", LangRU: "Год"},
	"stats.busiestDay":    {LangEN: "Busiest day:", LangRU: "Самый долгий день:"},
	"stats.less":          {LangEN: "less", LangRU: "меньше"},
	"stats.more":          {LangEN: "more", LangRU: "больше"},
	"stats.whenYouRead":   {LangEN: "When you read", LangRU: "Когда вы читаете"},
	"stats.localTime": {
		LangEN: "By the clock on this server, which is where the hour of the day has to come from.",
		LangRU: "По часам сервера — часовой пояс взять больше неоткуда.",
	},
	"stats.byBook":      {LangEN: "Book by book", LangRU: "По книгам"},
	"stats.book":        {LangEN: "Book", LangRU: "Книга"},
	"stats.progress":    {LangEN: "Progress", LangRU: "Прогресс"},
	"stats.lastRead":    {LangEN: "Last read", LangRU: "Последний раз"},
	"stats.chapter":     {LangEN: "Chapter", LangRU: "Глава"},
	"stats.reading":     {LangEN: "Your reading", LangRU: "Ваше чтение"},
	"stats.allBooks":    {LangEN: "Every book", LangRU: "Все книги"},
	"stats.min":         {LangEN: "min", LangRU: "мин"},
	"stats.hr":          {LangEN: "h", LangRU: "ч"},
	"stats.notMeasured": {LangEN: "not measured yet", LangRU: "ещё не измерено"},
	"stats.doneBy":      {LangEN: "Finished by", LangRU: "Дочитаете к"},
	"stats.aDay":        {LangEN: "a day", LangRU: "в день"},
	"stats.measuring": {
		LangEN: "Some books have not been measured yet, so their speed is missing. It happens in the background.",
		LangRU: "Некоторые книги ещё не измерены, поэтому скорости по ним нет. Это делается в фоне.",
	},
	...
	"collections.loose":            {LangEN: "Shelf for books in no series", LangRU: "Полка для книг вне серий"},
	"collections.loosePlaceholder": {LangEN: "Standalones", LangRU: "Отдельные книги"},
	"collections.looseHint": {
		LangEN: "With series becoming shelves, everything in no series has none — half a library reachable only through the full list. Name a shelf and they all go there. Leave it empty for no such shelf.",
		LangRU: "Когда серии становятся полками, книги вне серий не попадают никуда — полбиблиотеки достаётся только через общий список. Задайте название — и все они окажутся там. Пусто — такой полки не будет.",
	},
	"collections.hint": {
	...
	"book.seriesFromLibrary": {
		LangEN: "Read from the library. Change it here and the edit survives every later scan.",
		LangRU: "Прочитано из библиотеки. Измените здесь — и правка переживёт любое последующее сканирование.",
	},
	"book.seriesNone": {
		LangEN: "This book is in no series. Type a name to put it in one — an existing name will suggest itself.",
		LangRU: "Книга не входит ни в одну серию. Введите название, чтобы добавить её, — существующие подскажутся.",
	},
	"book.seriesOpen":  {LangEN: "The series", LangRU: "К серии"},
	"series.addBook":   {LangEN: "Add a book", LangRU: "Добавить книгу"},
	"series.addOne":    {LangEN: "Add", LangRU: "Добавить"},
	"series.addSearch": {LangEN: "Find a book", LangRU: "Найти книгу"},
	"series.addHint": {
		LangEN: "Find a book anywhere in the library and put it here. A book already in another series moves; nothing is copied.",
		LangRU: "Найдите книгу где угодно в библиотеке и добавьте её сюда. Книга из другой серии переедет — ничего не копируется.",
	},
	"series.addPlaceholder":       {LangEN: "Title or author", LangRU: "Название или автор"},
	"series.addNothing":           {LangEN: "Nothing matches, or everything that does is already here.", LangRU: "Ничего не нашлось — или всё найденное уже здесь."},
	...
	"api.title":              {LangEN: "Kobo API", LangRU: "API Kobo"},
	"api.download":           {LangEN: "OpenAPI document", LangRU: "Документ OpenAPI"},
	"api.sections":           {LangEN: "Sections", LangRU: "Разделы"},
	"api.parameters":         {LangEN: "Parameters", LangRU: "Параметры"},
	"api.param":              {LangEN: "Name", LangRU: "Имя"},
	"api.in":                 {LangEN: "Where", LangRU: "Где"},
	"api.type":               {LangEN: "Type", LangRU: "Тип"},
	"api.meaning":            {LangEN: "What it is", LangRU: "Что это"},
	"api.required":           {LangEN: "required", LangRU: "обязателен"},
	"api.requestBody":        {LangEN: "Request body", LangRU: "Тело запроса"},
	"api.responses":          {LangEN: "Responses", LangRU: "Ответы"},
	"api.kind.served":        {LangEN: "served", LangRU: "отвечаем"},
	"api.kind.servedWhat":    {LangEN: "answered here, out of the library", LangRU: "отвечает kobibri, из библиотеки"},
	"api.kind.relayed":       {LangEN: "relayed", LangRU: "релей"},
	"api.kind.relayedWhat":   {LangEN: "offered to the Kobo store first, answered here if it refuses", LangRU: "сначала спрашиваем стор, при отказе отвечаем сами"},
	"api.kind.proxyable":     {LangEN: "proxyable", LangRU: "проксируемый"},
	"api.kind.proxyableWhat": {LangEN: "no answer of our own; relayed if a device asks", LangRU: "своего ответа нет, релеим если девайс спросит"},
	"api.legend.does":        {LangEN: "What this server does", LangRU: "Что делает сервер"},
	"api.legend.knows":       {LangEN: "How much we know", LangRU: "Насколько мы уверены"},
	"api.ev.observed":        {LangEN: "observed", LangRU: "видели"},
	"api.ev.observedWhat":    {LangEN: "caught on real hardware, in our own traces", LangRU: "поймано на живой читалке, в наших логах"},
	"api.ev.implemented":     {LangEN: "implemented", LangRU: "реализовано"},
	"api.ev.implementedWhat": {LangEN: "served and tested, but no device has been seen calling it", LangRU: "отвечаем и покрыто тестами, но девайс за этим не заставали"},
	"api.ev.unproven":        {LangEN: "unproven", LangRU: "не проверено"},
	"api.ev.unprovenWhat":    {LangEN: "nothing observed; no schema, because inventing one is worse", LangRU: "ничего не видели; схемы нет — выдумывать хуже"},
	"library.newestFirst":    {LangEN: "Newest first", LangRU: "Сначала новые"},
	"library.byTitle":        {LangEN: "By title", LangRU: "По названию"},
	"library.lastActivity":   {LangEN: "Last read", LangRU: "Последние по чтению"},
